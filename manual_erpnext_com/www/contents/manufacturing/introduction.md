...
Broadly there are three types of Production Planning Systems
  ...
  * __[Make-to-Stock](/contents/manufacturing/make-to-stock):__ In these systems, production is planned based on a forecast and the Items are then sold to distributors or customers. All fast moving consumer goods that are sold in retail shops like soaps, packaged water etc and electronics like phones etc are Made-to-Stock.
  * __[Make-to-Order](/contents/manufacturing/make-to-order):__ In these systems, manufacturing takes place after a firm order is placed by a customer.
