...
2. Valuation Rate of items are recalculated based on new landed cost. Read more about valuation at [Item Valuation FIFO and Moving Average](/stock/item-valuation-fifo-and-moving-average).![Purchase Receipt Stock Ledger Entries](assets/manual_erpnext_com/old_images/erpnext/purchase_receipt_stock_ledger_entries.png)
